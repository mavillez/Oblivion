...
- Testing software for different toolchains
    ...
    - Miguel Avillez: General testing of the software, parallel runs, Dalton, GPAW, GROMACs, Astrophysical software (ZeusMP, MAP, GADGET, CPIPES (Avillez 2018), Evora-Vienna Astrophysical Fluids Parallel Adaptive Mesh Refinement software (Avillez 2005), MHDISMv4-CT-NEI - Parallel Adaptive Mesh Refinement MHD Non-Equilibrium Ionization software (Avillez 2026))
